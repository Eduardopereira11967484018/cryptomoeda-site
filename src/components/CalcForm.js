...
const CalcForm = () => {
  return (
    <div
      className="w-full bg-white max-w-[942px] mx-auto rounded-2xl p-12 shadow-primary text-darkblue"
      data-aos="fade-up"
      data-aos-offset="500"
    >
      {/* Form */}
      ...
      <div className="mt-24">
        ...
        <div className="text-[32px] font-bold mb-3">
          0.055 130 50 ETH <span className="text-blue">(1275$)</span>
        </div>
        <div className="text-gray-500 tracking-[1%]">
          Revenue will change based in mining difficulty and Ethereum Price
        </div>
      </div>
    </div>
  );
